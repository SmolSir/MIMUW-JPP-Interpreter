...
instance Print (Grammar.Abs.Arg' a) where
  prt i = \case
    Grammar.Abs.ArgByVal _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_])
    Grammar.Abs.ArgByRef _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "&"), prt 0 id_])
...
instance Print (Grammar.Abs.Stmt' a) where
  prt i = \case
    ...
    Grammar.Abs.RetVal _ expr -> prPrec i 0 (concatD [doc (showString "return"), prt 0 expr, doc (showString ";")])
    Grammar.Abs.RetVoid _ -> prPrec i 0 (concatD [doc (showString "return"), doc (showString ";")])
