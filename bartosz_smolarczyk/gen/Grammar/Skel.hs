...
transArg x = case x of
  Grammar.Abs.ArgByVal _ type_ ident -> failure x
  Grammar.Abs.ArgByRef _ type_ ident -> failure x
...
transStmt x = case x of
  ...
  Grammar.Abs.RetVal _ expr -> failure x
  Grammar.Abs.RetVoid _ -> failure x
