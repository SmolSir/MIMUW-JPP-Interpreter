...
Arg
  : Type Ident { (fst $1, Grammar.Abs.ArgByVal (fst $1) (snd $1) (snd $2)) }
  | Type '&' Ident { (fst $1, Grammar.Abs.ArgByRef (fst $1) (snd $1) (snd $3)) }
...
Stmt
  ...
  | 'return' Expr ';' { (uncurry Grammar.Abs.BNFC'Position (tokenLineCol $1), Grammar.Abs.RetVal (uncurry Grammar.Abs.BNFC'Position (tokenLineCol $1)) (snd $2)) }
  | 'return' ';' { (uncurry Grammar.Abs.BNFC'Position (tokenLineCol $1), Grammar.Abs.RetVoid (uncurry Grammar.Abs.BNFC'Position (tokenLineCol $1))) }
